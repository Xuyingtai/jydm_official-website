...
const Home = () => {
  ...
  const services = [
    ...
    {
      title: 'AIGC图片与视频生成制作',
      description: '利用人工智能技术打造创新内容创作平台，通过AI技术高效创作动画内容，提供AI辅助创作、智能风格转换、快速生成等专业服务。',
      icon: '🤖'
    }
  ]
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p className="hero-description">
              郑州吉音动漫科技有限公司，注册资金500万元，致力于动画影视制作、AIGC生成式内容创作、商业工作流研发、各类型商品详情页制作、吉祥物设计制作、周边衍生产品开发制作、动漫广告视频制作、网站建站设计等业务。河南省乡村振兴产业发展专业委员会文创企业代表、河南省动漫协会理事单位、郑州市认证动漫企业、郑轻易斯顿美术学院就业创业实训基地、中原股权交易中心新四板上市企业。
            </p>
